...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<h1>All product Price in Bangladesh</h1>
			<p>All product Price starts from BDT 1,044 in Bangladesh and depending on the brand and features up to BDT 300,000 can be the price of a mobile phone. You can get the latest feature phones, budget smartphones, and high-configuration  at shopping portal. Check below and Order yours now!</p>
